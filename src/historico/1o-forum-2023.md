...
participantes: >-
  ...
  atividades acadêmicas do Programa nos dois dias, com controle de
...
arquivos:
  - titulo: "Panorama do PPGMUS"
    ...
    descricao: >-
      Slides de abertura do Fórum: trajetória do Programa (mestrado em
      1999, doutorado em 2013), panorama geral apresentado por Edite Rocha
      e Betânia Parisi e composição da COMAPE ao longo de suas gestões.
---

Primeira edição do Fórum, que lançou o processo de autoavaliação do
PPGMUS: apresentação do panorama do Programa, da situação da proposta de
alteração da grade curricular então em análise na PRPG, do impacto dos
