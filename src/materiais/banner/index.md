...
title: "COMAPE — banner do site (2000×743px)"
permalink: /materiais/banner/
...
<div class="aviso-captura">
  ...
  <code>&lt;div class="tela-banner"&gt;</code> → <strong>Capture node
  screenshot</strong>. Sai um PNG 2000×743px exato.
  <br><a href="{{ '/materiais/' | rel }}">← voltar para Materiais</a>
</div>

<div class="tela-banner">
  <section class="hero hero--media tela-banner__hero">
    <div class="hero__media">
      <img src="{{ '/assets/img/hero-ufmg-pb.jpg' | rel }}" alt="">
    </div>
    <div class="tela-banner__conteudo">
