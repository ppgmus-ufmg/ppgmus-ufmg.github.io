...
title: "COMAPE — pôster A3 (sem \"programação em breve\")"
permalink: /materiais/poster/a3-sem-programacao/
eleventyExcludeFromCollections: true
---

<div class="aviso-captura">
  Espere a animação terminar (~4s). Depois, Ctrl/Cmd+P → destino
  "Salvar como PDF" → papel <strong>A3</strong>, margens
  <strong>nenhuma</strong>, sem cabeçalho/rodapé, escala 100%.
  Com a chamada "Programação em breve"? Use
  <a href="{{ '/materiais/poster/a3/' | rel }}">esta versão</a>.
  <br><a href="{{ '/materiais/' | rel }}">← voltar para Materiais</a>
</div>

<div class="folha-a3">
  <section class="hero hero--media folha-a3__hero">
    <div class="hero__media">
      <img src="{{ '/assets/img/hero-ufmg-pb.jpg' | rel }}" alt="">
    </div>
    <div class="folha-a3__conteudo">
